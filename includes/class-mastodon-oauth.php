...
class Mastodon_OAuth {
	...
	public function __construct() {
		...
		add_filter( 'login_redirect', array( $this, 'override_login_redirect' ), PHP_INT_MAX, 3 );
	}
	 ...
	 */
	public function override_login_redirect( $redirect_to, $requested_redirect_to, $user ) {
